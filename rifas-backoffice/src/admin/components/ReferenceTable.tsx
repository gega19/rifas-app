        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left py-3 px-4 font-semibold text-gray-700">Valor/Ticket</th>
          ...
          <tbody>
            {references.map((ref, index) => (
              ...
              >
                ...
                <td className="py-3 px-4">
                  {ref.ticketValue ? `$${Number(ref.ticketValue).toLocaleString('es-VE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : '-'}
                </td>
                <td className="py-3 px-4 font-semibold">
                  {ref.ticketValue ? `$${(Number(ref.ticketValue) * ref.ticketCount).toLocaleString('es-VE', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}` : '-'}
                </td>
                <td className="py-3 px-4">
                  {ref.used ? (
