...
export function References() {
  ...
  const handleCreate = async (data: { reference: string; ticketCount: number; ticketValue?: number | null }) => {
    try {
  ...
  const handleUpdate = async (id: string, data: { ticketCount?: number; ticketValue?: number | null; used?: boolean }) => {
    try {
  ...
  const handleBulkCreate = async (references: Array<{ reference: string; ticketCount: number; ticketValue?: number | null }>) => {
    try {
